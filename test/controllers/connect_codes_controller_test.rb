...
class ConnectCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connect_code" do
    assert_difference('ConnectCode.count') do
      post connect_codes_url, params: { connect_code: { assigned: @connect_code.assigned, code: @connect_code.code } }
    end
  ...
  test "should update connect_code" do
    patch connect_code_url(@connect_code), params: { connect_code: { assigned: @connect_code.assigned, code: @connect_code.code } }
